...
from mdp_attacks import reset_state_transfer_attack_runtime
from mdp_attacks.attack_monitor import consume_window_attack_events, reset_window_attack_events
...
class SatelliteEnv(SatelliteSimulation):
    ...
    def step(self,epsilon):
        ...
        experience_records = self.simulator.propagator.experience_records
        experiences_by_agent = self.simulator.propagator.experiences_by_agent
        action_logs = self.simulator.propagator.action_logs
        self.simulator.propagator.experiences = []
        self.simulator.propagator.experience_records = []
        self.simulator.propagator.experiences_by_agent = {}
